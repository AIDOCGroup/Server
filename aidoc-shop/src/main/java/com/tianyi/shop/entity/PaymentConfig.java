 ...
 */
@Entity
@Table(name = "SHOP_PAYMENT_CONFIG")
public class PaymentConfig extends BaseEntity<Long> {
    ...
    public void setPaymentFee(BigDecimal paymentFee) {
        this.paymentFee = ShopConfigUtil.getPriceScaleBigDecimal(paymentFee);
    }
    ...
    public BigDecimal getPaymentFee(BigDecimal totalAmount) {
        ...
        return ShopConfigUtil.getOrderScaleBigDecimal(paymentFee);
    }
