...
import com.tianyi.shop.entity.Product.WeightUnit;
import com.tianyi.shop.util.ArithUtil;
...
public class DeliveryType extends BaseEntity<Long> {
    ...
    public void setFirstWeightPrice(BigDecimal firstWeightPrice) {
        this.firstWeightPrice = ShopConfigUtil.getPriceScaleBigDecimal(firstWeightPrice);
    }
    ...
    public void setContinueWeightPrice(BigDecimal continueWeightPrice) {
        this.continueWeightPrice = ShopConfigUtil.getPriceScaleBigDecimal(continueWeightPrice);
    }
    ...
    public BigDecimal getDeliveryFee(double totalWeight, WeightUnit totalWeightUnit) {
        ...
        return ShopConfigUtil.getOrderScaleBigDecimal(deliveryFee);
    }
