...
public class NewsDao extends BaseDao<News> {
     ...
     * 新闻列表
     */
    public List<News> getNews(final NewsEnum newsType, final LanguageEnum lang, final int page, final int pageSize,String keyword) {
        ...
        if(!StringUtil.isStringEmpty(keyword)){
            strb.append(" and title LIKE '%"+keyword+"%'");
        }
    ...
    public Integer getNoReadNumber(final NewsEnum newsType,final LanguageEnum lang,String keyword) {
