...
public class User extends BaseBo implements Serializable {
    ...
    public String getRegistInvitationCode() {
        return registInvitationCode;
    }

    public void setRegistInvitationCode(String registInvitationCode) {
        this.registInvitationCode = registInvitationCode;
    }

    public int getIsNeedModifyPassword() {
        return isNeedModifyPassword;
    }

    public void setIsNeedModifyPassword(int isNeedModifyPassword) {
        this.isNeedModifyPassword = isNeedModifyPassword;
    }
}
