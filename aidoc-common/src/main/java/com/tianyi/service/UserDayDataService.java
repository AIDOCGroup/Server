...
import com.tianyi.mapper.UserDayDataMapper;
...
public class UserDayDataService {
    ...
    @Autowired
    UserDayDataMapper userDayDataMapper;
    ...
    public List<StepRankings> getRealTimeStepRankings(Map param) {
        return userDayDataMapper.getRealTimeStepRankins(param);
    }
}
