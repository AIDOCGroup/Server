...
public class InvitationService {
    public static final Logger logger = LoggerFactory.getLogger(InvitationService.class);
...
//        invitation.setInvitationCode(invitationCode);
    ...
    public List<InvitationResult> getAllInvitationTwo(Integer page,Integer size){
        Map param=new HashMap();
        int offset=0;
...
//      if (rewardNum<50) {
          //一级奖励上限50人
          accountService.consumeCoin(userId,"invitation1",10000);
//      }
      //二级奖励
